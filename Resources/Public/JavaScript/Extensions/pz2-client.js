	...
	*/
	var appendFacetHistogramForDatesTo = function (terms, histogramContainer) {
		...
		for (var termIndex in terms) {
			...
			// year might be much higher than actual year, like 9999
					...
					*/
					...
					if (selectedBook !== undefined) {
						...
						*/
						...
						var buttonImageURL = 'https://www.google.com/intl/' + language + '/googlebooks/images/gbs_preview_button1.gif';
		...
		*/
		var KVKItem = function (data) {
			...
			if (query !== '') {
				...
				var KVKLinkURL = 'https://kvk.bibliothek.kit.edu/hylib-bin/kvk/nph-kvk2.cgi';
				KVKLinkURL += '?maske=kvk-redesign&title=KIT-Bibliothek%3A+Karlsruher+Virtueller+Katalog+KVK+%3A+Ergebnisanzeige';
				KVKLinkURL += '&head=%2F%2Fkvk.bibliothek.kit.edu%2Fasset%2Fhtml%2Fhead.html&header=%2F%2Fkvk.bibliothek.kit.edu%2Fasset%2Fhtml%2Fheader.html';
				KVKLinkURL += '&spacer=%2F%2Fkvk.bibliothek.kit.edu%2Fasset%2Fhtml%2Fspacer.html&footer=%2F%2Fkvk.bibliothek.kit.edu%2Fasset%2Fhtml%2Ffooter.html';
				KVKLinkURL += '&css=none&input-charset=utf-8&Timeout=120';
				KVKLinkURL += localise('&lang=en');
        ...
        if (extraLinkList.childNodes.length > 0) {
            var tempLinks = document.createElement('dd');
            jQuery(tempLinks).addClass('pz2-extraLinks');
            var exportLinksLabel = document.createElement('dt');
            tempLinks.appendChild(exportLinksLabel);
            ...
            tempLinks.appendChild(extraLinkList);

            exportLinks = [exportLinksLabel, tempLinks];
        }
